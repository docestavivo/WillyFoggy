...
import static com.example.estefania.willyfoggy.R.id.imageView;
...
public class MenuActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_perfil) {
            ...
            Log.i("HA ENTRADO", "Ha entrado a amigos.");
        ...
        if (FragmentTransaction) {
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.pantalla, fragment)
                    .commit();
    ...
    public void enviarEmail (View v){
        String[] TO = {"docestavivo@gmail.com"}; //aquí pon tu correo
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Error en Willy Foggy");
        emailIntent.putExtra(Intent.EXTRA_TEXT, "Por favor, concreta el error de la aplicación.");
